...
public class MainCalculadora extends Application {
    ...
    public void start(Stage primaryStage) {
        try {
            BorderPane root = (BorderPane) FXMLLoader.load(getClass().getResource("/main/resources/es/unex/cum/mdp/sesion10/view/ej7Calculadora.fxml")); // Ponemos el fichero bfxml creado
